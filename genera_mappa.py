...
# 1. Punti di monitoraggio tra Piemonte e Liguria
punti_monitoraggio = [
...
# 2. Calcolo Indice Probabilità Funghi
def calcola_indice(pioggia_mm, vento_kmh):
    # Fattore Pioggia (ottimo 60-120mm)
    ...
    # Fattore Vento (penalizza sopra gli 8 km/h)
...
# 3. Mappa Base OpenStreetMap
m = folium.Map(location=[44.5, 8.2], zoom_start=8, tiles="OpenStreetMap")
heat_data = []

# 4. Recupero dati remoti via API Open-Meteo
...
# 5. Salva come index.html per la pubblicazione web
m.save("index.html")
print("Mappa aggiornata con successo su file index.html!")
